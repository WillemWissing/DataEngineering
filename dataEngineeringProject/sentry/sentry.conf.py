...
CSRF_COOKIE_SECURE = False  # or based on your environment
SENTRY_USE_CSRF = False

SECURE_PROXY_SSL_HEADER = ('HTTP_X_FORWARDED_PROTO', 'https')
# CSRF_TRUSTED_ORIGINS = ['*']
CSRF_TRUSTED_ORIGINS = ['spark-spark-submit']

SENTRY_OPTIONS['system.url-prefix'] = 'http://sentry-sentry-1:9000'
